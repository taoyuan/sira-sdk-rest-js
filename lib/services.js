...
module.exports = function generateServices(sapp, ngModuleName, apiUrl) {
    ngModuleName = ngModuleName || 'siras';
    apiUrl = apiUrl || '/';

    var models = describeModels(sapp);

    var servicesTemplate = fs.readFileSync(require.resolve('./services.template'), { encoding: 'utf-8' });
...
//        c.isUser = c.sharedClass.ctor.prototype instanceof sapp.model('user');
